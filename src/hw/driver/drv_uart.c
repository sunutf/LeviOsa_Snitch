...
/*
  ...
  _DEF_UART1          : VCP
  _DEF_UART2          : USART1		for Command to Drone
  _DEF_UART3          : USART2    for Bluetooth

*/
/*
  USART1
    - RX : PA10, DMA2, Stream5, Channel 4
    - TX : PA9, DMA2, Stream7, Channel 4

  USART2
    - RX : PA3, DMA1, Stream5, Channel 4
    - TX : PA2, DMA1, Stream6, Channel 4
