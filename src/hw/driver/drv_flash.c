...
bool drvFlashInit(void)
{
  ...
  flash_page_attr[0].length = 16*1024;

  flash_page_attr[1].addr   = 0x08004000;
  flash_page_attr[1].length = 16*1024;

  flash_page_attr[2].addr   = 0x08008000;
  flash_page_attr[2].length = 16*1024;

  flash_page_attr[3].addr   = 0x0800C000;
  flash_page_attr[3].length = 16*1024;

  flash_page_attr[4].addr   = 0x08010000;
  flash_page_attr[4].length = 64*1024;

  flash_page_attr[5].addr   = 0x08020000;
  flash_page_attr[5].length = 128*1024;

  flash_page_attr[6].addr   = 0x08040000;
  flash_page_attr[6].length = 128*1024;

  flash_page_attr[7].addr   = 0x08060000;
  flash_page_attr[7].length = 128*1024;

  flash_page_attr[8].addr   = 0x08080000;
  flash_page_attr[8].length = 128*1024;

  flash_page_attr[9].addr   = 0x080A0000;
  flash_page_attr[9].length = 128*1024;

  flash_page_attr[10].addr   = 0x080C0000;
  flash_page_attr[10].length = 128*1024;

  flash_page_attr[11].addr   = 0x080E0000;
  flash_page_attr[11].length = 128*1024;
